...
- Já vem com tudo: roteamento, JSON, autenticação, injeção de dependência, Swagger…
...
Abra `Program.cs`. Em projetos modernos (.NET 6+), está enxuto:
...
Acesse o Swagger: <https://localhost:5001/swagger>. Você vai ver os 5 endpoints prontos para testar pela interface.
...
## 10.9 Testando com Swagger

O Swagger é uma página interativa que **lê seus controllers** e gera uma UI de testes automática.
