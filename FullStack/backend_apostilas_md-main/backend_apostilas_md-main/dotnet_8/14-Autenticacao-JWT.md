...
## 14.11 Configurando o Swagger para JWT

Para que o Swagger permita testar endpoints protegidos:
...
Agora, no Swagger, aparece um botão **🔒 Authorize** no topo. Cole `Bearer <seu_token>` e teste à vontade.
...
6. Teste tudo no Swagger: tente acessar sem token → deve dar 401. Faça login, copie o token, autorize, e teste novamente.
